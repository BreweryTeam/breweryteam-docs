...
| `<plugin_name>:<item_id>/<amount>` | An item from another plugin. See <DynamicLink href="/[lang]/docs/tbp/for-server-owners/reference/integrations">Integrations</DynamicLink> page.           |
| `brewery:<brew_id>/<amount>`       | Another brew from TheBrewingProject.                                                                                                                      |
| `#brewery:<group_id>/amount`       | An ingredient group reference. See <DynamicLink href="/[lang]/docs/tbp/for-server-owners/config/ingredient-groups/">Ingredient Groups</DynamicLink> page. |
