...
Please the blocks in the exact pattern shown below placing the sign last with the text "barrel" on the first line.

![a big & a small barrel](/assets/docs/breweryx/gameplay/creating-brews/aging/barrels.png)

<Callout type="info">
Despite what many players think, you don't actually need those four fences under the big barrel. Don't buy Big Fence's lies!
</Callout>
