...
<Callout title="Ingredients">
    See [Ingredients Basics](../../reference/basics/#ingredients) for more information about the ingredient format
</Callout>
...
<Callout title="Barrel Types">
    More about barrel types can be found in [Aging guide](/docs/for-players/brewing/aging/#barrel-types)
</Callout>
