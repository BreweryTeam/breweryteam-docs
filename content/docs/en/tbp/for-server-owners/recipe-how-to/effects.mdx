...
This format is described more in detail in the [Quality Factored List](/docs/for-server-owners/reference/basics/#quality-factored-list) section of the Basics page.
